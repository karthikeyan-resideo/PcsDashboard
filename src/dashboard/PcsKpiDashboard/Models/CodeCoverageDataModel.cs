namespace PcsKpiDashboard.Models
{
    ...
    public class DataResult
    {
        ...
        public List<CodeCoverageDataModel> CoverageDataResults { get; set; }
        public TotalIssuesCount TotalIssuesCount { get; set; }
    }
    public class SonarQubeDetailResult
    {
        public string ProjectName { get; set; }
        public int CodeSmells { get; set; }
        public int Bugs { get; set; }
